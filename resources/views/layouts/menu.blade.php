        ...
        <div class="category-card mb-4">
          ...
          <div class="border rounded p-2 mb-2 descripcion" style="display:none;">
            ...
            <div class="d-flex justify-content-end gap-2 align-items-center">
              <button class="btn btn-sm btn-outline-primary btn-edit" data-id="{{ $categoria->id }}"
                onclick="startEdit(this, 'categoria', '{{ $categoria->id }}')">
          ...
          <div class="border rounded bg-light p-2 ms-3 mb-2 classification-card">
            ...
            <div class="descripcion" style="display:none;">
              ...
              <div class="d-flex justify-content-end gap-2">
                <button class="btn btn-sm btn-outline-success btn-edit" data-id="{{ $clasificacion->id }}"
                  onclick="startEdit(this, 'clasificacion', '{{ $clasificacion->id }}')">
                  <i class="bi bi-pencil"></i> Editar
                </button>
